...
resourcegroup_name = 'odh'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'odh'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
# Here, we add an entry for cars with 5 pieces of data - the make, model, year, color & price
#
...
car.price = 6000
table_service.insert_entity('itemstable', car)
print('Created entry for Toyota Avensis...')
...
coffee.flavor = 'carmel'
coffee.size = '12oz'
coffee.price = 4
table_service.insert_entity('itemstable', coffee)
print('Created entry for a carmel coffee...\n')
time.sleep(1)
...
coffee.price = 5.5
table_service.insert_entity('itemstable', coffee)
print('Created entry for vanilla coffee...\n')
time.sleep(1)
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffee'", select='flavor,price')
for item in items:
